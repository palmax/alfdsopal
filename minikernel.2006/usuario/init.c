 ...
 * usuario/init.c
 *
 *  Minikernel. Versi� 1.0
 *
 *  Fernando P�ez Costoya
 *
 */

/* Programa inicial que arranca el S.O. S�o se ejecutar� los programas
...
/*
 *
 * Contiene las mismas pruebas que se realizan para evaluar la pr�tica.
 * Para llevar a cabo cada prueba, comente y descomente
 * las l�eas correspondientes. En la versi� inicial, la parte descomentada
